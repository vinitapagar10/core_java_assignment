...
public class StudentCourse {
	...
	public StudentCourse(String coursename, int discount, double coursefee, double discountedcoursefee) {
		super();
	...
	public String toString() {
		return "StudentCourse [coursename=" + coursename + ", discount=" + discount + ", coursefee=" + coursefee
